    ...
    <div class="new-book">
      <form>
        <p>
          ...
          <input type="text" placeholder="00/00/0000" name="">
        </p>
        <p>
        ...
        <p>
          ...
          <input type="text" placeholder="Additional Stop Location" name="">
        </p>
        <p>
        ...
        <p>
          <label>Existing Client/Member</label>
          <select>
        ...
        <p>
          <label>Pickup Time(Eg: 10:00AM)</label>
          <input type="text" placeholder="00:00 AM" name="">
        </p>
        <p>
        ...
        <p>
          <label>Baby/Booster Seater</label>
          <input type="text" name="">
        </p>
        <p>
          <label>No. of Luggage/Suitcase</label>
          <input type="text" placeholder="0" name="">
        </p>
        <p>
          <input type="button" class="but" value="Continue Booking">
        </p>
      </form>
    </div>
  </div>

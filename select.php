...
<div id="container">
  ...
  <div id="content">
    ...
    <div class="vehicle">
      <form>
        <div class="col-md-3"> <img src="images/pic1.jpg">
          <h4>EON</h4>
          <p>4 Passengers, 2 Hand Luggages, 2 Suite Cases</p>
          <p>
            <input type="radio">
            <label>One Way Price : <span>$20.55</span> </label>
            <br>
            <input type="radio">
            <label> Return & Wait Price: <span>$20.55</span></label>
          </p>
          <p>
            <input type="button" value="Book Now" name="book" class="but">
          </p>
        </div>
        <div class="col-md-3"> <img src="images/pic2.jpg">
          <h4>EON</h4>
          <p>4 Passengers, 2 Hand Luggages, 2 Suite Cases</p>
          <p>
            <input type="radio">
        ...
        <div class="col-md-3"> <img src="images/pic3.jpg">
          <h4>EON</h4>
          <p>4 Passengers, 2 Hand Luggages, 2 Suite Cases</p>
          <p>
            <input type="radio">
        ...
        <div class="col-md-3"> <img src="images/pic4.jpg">
          <h4>EON</h4>
          <p>4 Passengers, 2 Hand Luggages, 2 Suite Cases</p>
          <p>
            <input type="radio">
        ...
        <div class="col-md-3"> <img src="images/pic5.jpg">
          <h4>EON</h4>
          <p>4 Passengers, 2 Hand Luggages, 2 Suite Cases</p>
          <p>
            <input type="radio">
        ...
        <div class="col-md-3"> <img src="images/pic6.jpg">
          <h4>EON</h4>
          <p>4 Passengers, 2 Hand Luggages, 2 Suite Cases</p>
          <p>
            <input type="radio">
        ...
        <div class="col-md-3"> <img src="images/pic7.jpg">
          <h4>EON</h4>
          <p>4 Passengers, 2 Hand Luggages, 2 Suite Cases</p>
          <p>
            <input type="radio">
        ...
        <div class="col-md-3"> <img src="images/pic8.jpg">
          <h4>EON</h4>
          <p>4 Passengers, 2 Hand Luggages, 2 Suite Cases</p>
          <p>
            <input type="radio" value="OneWayPrice" checked>
            <label>One Way Price : <span>$20.55</span> </label>
            <br>
            <input type="radio" value="ReturnWaitPrice">
            <label> Return & Wait Price: <span>$20.55</span></label>
          </p>
          <p>
            <input type="button" value="Book Now" name="book" class="but">
      ...
      <p>Note: Prices are estimated only. Final Prices will be provided after Booking Confirmation</p>
    </div>
  </div>
  <!-- Content ends --> 
